...
module "prod_vps" {
  ...
  droplet_id        = module.prod_vps[0].droplet_id_output
...
module "dns" {
  ...
  ip_address        = var.enable_vps_module ? module.prod_vps[0].droplet_ip : "N/A"
  subdomain_name    = var.enable_subdomain
  subdomain_ip      = var.enable_vps_module ? module.prod_vps[0].droplet_ip : "N/A"
}
...
module "networking" {
  ...
  droplet_ids              = [module.prod_vps[0].droplet_id_output]
}
...
module "storage" {
  ...
  droplet_id_output  = var.enable_vps_module ? module.prod_vps[0].droplet_id_output : null
  droplet_ids        = [module.prod_vps[0].droplet_id_output]
}
